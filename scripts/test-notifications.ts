...
const scenarios: Scenario[] = [
  {
    label: "Restocked",
    previous: { price: 20, in_stock: false, original_price: null, promo_label: null },
    result: { price: 20, currency: "EUR", inStock: true },
    historicalMinPrice: 18,
  },
  {
    label: "Went out of stock",
    previous: { price: 20, in_stock: true, original_price: null, promo_label: null },
  ...
  {
    label: "Price dropped",
    previous: { price: 15, in_stock: true, original_price: null, promo_label: null },
    result: { price: 13, currency: "EUR", inStock: true },
    historicalMinPrice: 13,
  },
  {
    label: "Price increased",
    previous: { price: 13, in_stock: true, original_price: null, promo_label: null },
    result: { price: 16, currency: "EUR", inStock: true },
    historicalMinPrice: 13,
  },
  {
    label: "All-time low",
    previous: { price: 16, in_stock: true, original_price: null, promo_label: null },
    result: { price: 12, currency: "EUR", inStock: true },
    historicalMinPrice: 13,
  },
  {
    label: "Combined (restocked + new offer + all-time low)",
    previous: { price: 25, in_stock: false, original_price: null, promo_label: null },
